...
<div class="container text-center nav-monk">
  <div class="row">
    <div class="col" style="color: #d3d3d3;">
        <a href="" class="font-nav">< อาหารหลัก</a>
    </div>
    <div class="col">
      เมนูแนะนำ
    </div>
    <div class="col" style="color: #d3d3d3; ">
      <a href="" class="font-nav">อาหารรองฮี้ย ></a>
    </div>
  </div>
</div>
<div class="container mt-4">
  <div class="row justify-content-center g-5 " >
    ...
    <div class="col-6 col-md-3 d-flex justify-content-center">
      <div class="card align-items-center menu-pic border-0" style="width: 17rem; border-radius: 25px;">
  ...
  <div class="row justify-content-center g-5 " >
    ...
    <div class="col-6 col-md-3 d-flex justify-content-center">
      <div class="card align-items-center menu-pic border-0" style="width: 17rem; border-radius: 25px;">
        ...
        <div class="card-body">
          <p class="food-font">Pad Kra Pao (หมู)</p>
          <p class="food-font1">Price 35 ฿</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-6 col-md-3 d-flex justify-content-center">
      <div class="card align-items-center menu-pic border-0" style="width: 17rem; border-radius: 25px; ">
        <img src="" class="card-img-top mt-3" style="width: 200px;" height="200px" alt="...">
        <div class="card-body">
          <p class="food-font">double chaese burger</p>
          <p class="food-font1">Price 35 ฿</p>
        </div>
      </div>
    </div>
...
<footer><img src="./assets/img/shopping-basket.png" class="floating-circle" alt="Circle Image"></footer>
</html>